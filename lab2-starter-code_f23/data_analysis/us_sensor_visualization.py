...
US_SENSOR_DATA_FILE = "/Users/isbatos/Documents/Fall_2023/ECSE_211/ECSE_211_Group24/us_sensor_tests/us_sensor_30_2.csv"
DELAY_SEC = 0.01
SIZE = 10
...
plt.ylim(10,40)
plt.title(f"US sensor {SIZE}cm measurements", fontsize=15)
plt.xlabel("Time (s)")
